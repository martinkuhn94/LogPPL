...
def calculate_petri_nets(log, threshold):
    ...
    :rtype: dict
    """
    net_inductive, initial_marking_inductive, final_marking_inductive = pm4py.discover_petri_net_inductive(log, noise_threshold=threshold)
    petri_net_list = [[net_inductive, initial_marking_inductive, final_marking_inductive]]
